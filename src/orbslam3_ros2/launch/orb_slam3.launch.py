...
def generate_launch_description():
    ...
    vocabulary_file_arg = DeclareLaunchArgument(
        'vocabulary_file',
        default_value='/home/gr/TB_ORB_SLAM3_ws/src/orbslam3_ros2/vocabulary/ORBvoc.txt',
        description='Path to the ORB-SLAM3 vocabulary file'
    )

    config_file_arg = DeclareLaunchArgument(
        'config_file',
        default_value='/home/gr/TB_ORB_SLAM3_ws/src/orbslam3_ros2/config/stereo-inertial/ZED2i.yaml',
